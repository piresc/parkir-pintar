...
RUN for svc in gateway reservation search billing payment presence; do \
...
COPY --from=builder /build/gateway /build/reservation /build/search /build/billing /build/payment /build/presence ./
