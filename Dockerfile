...
RUN for svc in gateway reservation search billing payment; do \
...
COPY --from=builder /build/gateway /build/reservation /build/search /build/billing /build/payment ./
