...
func (c *BillingClient) StartBilling(ctx context.Context, reservationID string, bookingFee int64, idempotencyKey string) (*reservation.BillingRecord, error) {
	var result *reservation.BillingRecord
...
func (c *BillingClient) startBillingInner(ctx context.Context, reservationID string, bookingFee int64, idempotencyKey string) (*reservation.BillingRecord, error) {
...
func (c *BillingClient) CalculateFee(ctx context.Context, reservationID string, checkInAt, checkOutAt time.Time) (*reservation.BillingRecord, error) {
	var result *reservation.BillingRecord
	err := c.cb.Execute(func() error {
		var err error
...
func (c *BillingClient) calculateFeeInner(ctx context.Context, reservationID string, checkInAt, checkOutAt time.Time) (*reservation.BillingRecord, error) {
...
func (c *BillingClient) GenerateInvoice(ctx context.Context, reservationID string, idempotencyKey string) (*reservation.BillingRecord, error) {
	var result *reservation.BillingRecord
	err := c.cb.Execute(func() error {
		var err error
...
func (c *BillingClient) generateInvoiceInner(ctx context.Context, reservationID string, idempotencyKey string) (*reservation.BillingRecord, error) {
...
func protoToBillingRecord(r *billingv1.BillingResponse) *reservation.BillingRecord {
	if r == nil {
		return nil
	}
