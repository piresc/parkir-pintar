...
func TestCreateReservation(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			mockResult: nil,
			mockErr:    model.ErrSpotUnavailable,
...
func TestCancelReservation(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			mockResult: nil,
			mockErr:    model.ErrInvalidTransition,
			wantCode:   codes.FailedPrecondition,
		},
	}
...
func TestListByDriver(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			mockResult: []*model.Reservation{
				{ID: "res-1", DriverID: "driver-123", Status: model.StatusConfirmed},
				{ID: "res-2", DriverID: "driver-123", Status: model.StatusConfirmed},
			},
			wantCode: codes.OK,
		},
		{
