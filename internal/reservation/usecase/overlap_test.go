...
func TestCreateReservation_ShouldSucceed_WhenMotorcycleSpotIsAvailable(t *testing.T) {
	...
	billing.On("StartBilling", mock.Anything, mock.AnythingOfType("string"), pricing.BookingFee, mock.AnythingOfType("string")).Return(&reservation.BillingRecord{ID: "billing-boundary-id"}, nil)
