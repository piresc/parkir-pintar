...
// Source: parkir-pintar/internal/search/usecase (interfaces: RedisClient)
//
// Generated by this command:
//
//	mockgen -destination=../mocks/mock_redis_client.go -package=mocks parkir-pintar/internal/search/usecase RedisClient
//
