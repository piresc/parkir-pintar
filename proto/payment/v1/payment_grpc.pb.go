...
const (
	...
	PaymentService_ProcessQRIS_FullMethodName      = "/payment.v1.PaymentService/ProcessQRIS"
...
type PaymentServiceClient interface {
	...
	ProcessQRIS(ctx context.Context, in *ProcessQRISRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
...
func (c *paymentServiceClient) ProcessQRIS(ctx context.Context, in *ProcessQRISRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentResponse)
	err := c.cc.Invoke(ctx, PaymentService_ProcessQRIS_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	// ProcessQRIS processes a QRIS-specific payment.
	ProcessQRIS(context.Context, *ProcessQRISRequest) (*PaymentResponse, error)
	// RefundPayment refunds a previously completed payment.
...
func (UnimplementedPaymentServiceServer) ProcessQRIS(context.Context, *ProcessQRISRequest) (*PaymentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessQRIS not implemented")
}
...
func _PaymentService_ProcessQRIS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessQRISRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).ProcessQRIS(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_ProcessQRIS_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ProcessQRIS(ctx, req.(*ProcessQRISRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ProcessQRIS",
			Handler:    _PaymentService_ProcessQRIS_Handler,
		},
		{
