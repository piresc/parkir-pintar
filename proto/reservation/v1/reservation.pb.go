...
type ReservationResponse struct {
	...
	SpotCode       string                 `protobuf:"bytes,13,opt,name=spot_code,json=spotCode,proto3" json:"spot_code,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ReservationResponse) GetSpotCode() string {
	if x != nil {
		return x.SpotCode
	}
	return ""
...
const file_proto_reservation_v1_reservation_proto_rawDesc = "" +
	"\n" +
	"&proto/reservation/v1/reservation.proto\x12\x0ereservation.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc5\x01\n" +
	...
	"\x0ereservation_id\x18\x01 \x01(\tR\rreservationId\"\xc0\x04\n" +
	...
	"\fcancelled_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\vcancelledAt\x12\x1b\n" +
	"\tspot_code\x18\r \x01(\tR\bspotCode\"J\n" +
...
var file_proto_reservation_v1_reservation_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
